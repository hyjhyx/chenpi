...
|---|---|
| 前缀（prefix） | `chenpi` |
| 命名空间 URI | `https://github.com/hyjhyx/chenpi#` |

术语 URI = 命名空间 URI + 术语名。例如 `chenpi:variety` 展开为：

```
https://github.com/hyjhyx/chenpi#variety
```
...
"@context": [
  ...
  { "chenpi": "https://github.com/hyjhyx/chenpi#" }
]
```
...
- **URI**：`https://github.com/hyjhyx/chenpi#variety` · **类型**：string
...
- **URI**：`https://github.com/hyjhyx/chenpi#origin` · **类型**：string
...
- **URI**：`https://github.com/hyjhyx/chenpi#seedSource` · **类型**：string
- 育种/种苗来源说明。
...
- **URI**：`https://github.com/hyjhyx/chenpi#plantingDate` · **类型**：date（ISO 8601，`YYYY-MM-DD`）
...
- **URI**：`https://github.com/hyjhyx/chenpi#maturity` · **类型**：string
...
- **URI**：`https://github.com/hyjhyx/chenpi#weightKg` · **类型**：number（单位固定为千克 kg）
...
- **URI**：`https://github.com/hyjhyx/chenpi#purchaseDate` · **类型**：date
...
- **URI**：`https://github.com/hyjhyx/chenpi#round` · **类型**：integer（从 1 起）
...
- **URI**：`https://github.com/hyjhyx/chenpi#fileHash` · **类型**：string（`sha256:<hex>`）
...
- **URI**：`https://github.com/hyjhyx/chenpi#spec` · **类型**：string
- 单品包装规格描述。
...
- **URI**：`https://github.com/hyjhyx/chenpi#unitCount` · **类型**：integer
...
- **URI**：`https://github.com/hyjhyx/chenpi#destGln` · **类型**：string（EPC SGLN URI）
- 分销发货的目的地（零售门店）位置码。
...
- **URI**：`https://github.com/hyjhyx/chenpi#inboundDate` · **类型**：date
- 零售门店收货入库/上架日期。
...
- **URI**：`https://github.com/hyjhyx/chenpi#soldDate` · **类型**：date
...
- **URI**：`https://github.com/hyjhyx/chenpi#peeling`
- 鲜柑果开皮并初步晒制为鲜皮的加工工序。用于 TransformationEvent（鲜果批次 → 陈皮批次），该事件的 `eventTime` 即**陈化起算点**（陈化年份的计算基准）。

<a id="sun_turning"></a>
### sun_turning — 翻晒

- **URI**：`https://github.com/hyjhyx/chenpi#sun_turning`
